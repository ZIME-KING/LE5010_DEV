...
void at_ceshi(void)
{
    ...
    if(buzou==36)
    {
        ...
        */
        ...
        shang_bao[7]=(crc_temp>>8);
        shang_bao[8]=(crc_temp&0x00ff);
...
//////////////////////////////////////////////////////////////
    ...
    if(buzou==31)
    {
        ...
        */
        ...
        kai_suo[7]=(crc_temp>>8);
        kai_suo[8]=(crc_temp&0x00ff);
...
//				}
    ...
    if(buzou==26)
    {
        ...
        */
        ...
        xin_tiao[15]=(crc_temp>>8);
        xin_tiao[16]=(crc_temp&0x00ff);//计算crc校验数据
...
//////////////////////////////////////////////////////////////
    ...
    if(buzou==21)
    {
        ...
        */
        ...
        qi_dong[15]=(crc_temp>>8);
        qi_dong[16]=(crc_temp&0x00ff);
